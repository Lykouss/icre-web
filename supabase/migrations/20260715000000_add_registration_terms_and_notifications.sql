-- =============================================================================
-- ICRE Migration - Termos de Inscrição e Notificações Retroativas
-- =============================================================================

-- 1. Adicionar colunas em event_registrations
ALTER TABLE public.event_registrations 
  ADD COLUMN IF NOT EXISTS terms_accepted_at TIMESTAMP WITH TIME ZONE,
  ADD COLUMN IF NOT EXISTS notified_events JSONB DEFAULT '[]'::jsonb;

-- 2. Atualizar a RPC de inserção para preencher terms_accepted_at para inscrições públicas comuns
...
BEGIN
  ...
  IF NOT FOUND THEN
    RETURN QUERY SELECT NULL::UUID, 'Evento nǜo encontrado.'::TEXT;
    RETURN;
  END IF;
