    ...
    <div className="flex items-center gap-6">
      ...
      <div className="relative shrink-0">
        ...
        {isPending && (
          <div className="absolute inset-0 rounded-full bg-black/60 flex items-center justify-center">
            <svg className="w-6 h-6 text-slate-900 dark:text-white animate-spin" fill="none" viewBox="0 0 24 24">
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-slate-900 dark:text-white text-sm font-semibold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        {preview && (
          <button
            ...
            disabled={isPending}
            className="flex items-center gap-2 px-4 py-2 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-red-400 hover:bg-red-500/10 rounded-xl transition-colors disabled:opacity-50"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
