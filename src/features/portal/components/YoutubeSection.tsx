...
export function YoutubeSection({ content }: Props) {
  ...
  return (
    <section id="youtube" className="relative py-24 px-6 bg-gray-50 dark:bg-slate-900/80 overflow-hidden" data-theme="light">
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          <span className="inline-flex items-center gap-2 text-xs font-bold text-red-600 dark:text-red-400 tracking-widest uppercase bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-900/30 px-3 py-1.5 rounded-full mb-5">
        ...
        >
          <div className="relative rounded-2xl overflow-hidden border border-gray-200 dark:border-slate-700 shadow-sm aspect-video bg-gray-100 dark:bg-slate-800">
            {videoId ? (
              <iframe
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-5">
                ...
                <div className="text-center">
                  <p className="text-gray-700 dark:text-slate-300 font-semibold">Configure o vídeo no painel</p>
                  <p className="text-gray-400 dark:text-slate-500 text-sm mt-1">Adicione um ID de vídeo do YouTube</p>
                </div>
              </div>
            )}
          </div>
