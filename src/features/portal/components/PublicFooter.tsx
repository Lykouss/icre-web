...
export function PublicFooter() {
  ...
  return (
    <footer className="bg-white dark:bg-slate-950 border-t border-black/5 dark:border-white/5 pt-20 pb-10 relative overflow-hidden">
      {/* Glow */}
          ...
          <div className="md:col-span-5 lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 mb-6 group inline-flex">
              <div className="relative w-9 h-9 transition-transform duration-300 group-hover:scale-110">
                <Image src="/logo.svg" alt="ICRE Logo" fill className="object-contain invert brightness-0" />
              </div>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/icre116?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-900 border border-black/10 dark:border-white/10 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-fuchsia-400 hover:border-fuchsia-500/30 hover:bg-fuchsia-500/10 transition-all duration-300">
