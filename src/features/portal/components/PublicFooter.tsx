      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="md:col-span-5 lg:col-span-4">
            <Link href="/" className="flex items-center gap-3 mb-6 group inline-flex">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[9px] font-bold tracking-[0.2em] text-slate-400 uppercase mt-1">Rocha Eterna</span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/icre116?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-slate-900 border border-white/10 flex items-center justify-center text-slate-400 hover:text-fuchsia-400 hover:border-fuchsia-500/30 hover:bg-fuchsia-500/10 transition-all duration-300">
          ...
          <div className="md:col-span-3 lg:col-span-2 lg:col-start-6">
            <h4 className="text-white font-bold mb-5 tracking-wide">Navegação</h4>
