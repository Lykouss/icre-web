...
function Hint({ children }: { children: React.ReactNode }) {
  return (
    <p className="flex items-start gap-2 text-xs text-slate-400 bg-slate-50 border border-slate-100 rounded-lg px-3 py-2.5 leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden">
            ...
            <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 shrink-0">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-0.5">Selecione ou envie uma nova imagem</p>
              </div>
    ...
    <div className="space-y-4">
      ...
      <Field label="Cor de fundo">
        <div className="flex items-center gap-2">
          ...
          <button onClick={() => set('bg_color', 'transparent')} className="text-xs text-slate-400 hover:text-slate-600 whitespace-nowrap">Limpar</button>
        </div>
      </Field>
    </div>
  );
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 shrink-0">
        <div>
          <p className="text-xs text-slate-400 font-medium uppercase tracking-wide">Editando</p>
