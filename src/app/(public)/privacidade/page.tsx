        ...
        <div className="space-y-12">
          ...
          <Section number="2" title="Dados que coletamos">
            ...
            <ul className="space-y-2 mt-2">
              ...
              'Informações de dispositivo e navegador (para otimização e logs)',
              ].map(item => (
          ...
          <Section number="6" title="Seus direitos (LGPD)">
            ...
            <p className="mt-4">
              ...
              <Link href="/suporte" className="text-blue-400 hover:text-blue-300 underline transition-colors">
                suporte
              </Link>.
            </p>
          </Section>
