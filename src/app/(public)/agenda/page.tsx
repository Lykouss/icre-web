      ...
      <div className="relative max-w-6xl mx-auto px-4 pt-28 pb-16">
        ...
        {(!events || events.length === 0) ? (
          <div className="flex flex-col items-center justify-center py-20 bg-blue-100 dark:bg-slate-900/40 border border-blue-300/60 dark:border-white/6 border-dashed rounded-3xl">
            ...
            <p className="text-slate-600 dark:text-slate-300 font-semibold mb-2">Nenhum evento programado</p>
                      ...
                      <div className="absolute bottom-3 left-3 flex gap-2">
                        ...
                        {event.isCancelled && (
                          <div className="bg-red-500/90 backdrop-blur-md border border-red-400/50 rounded-xl px-3 py-2 flex items-center shadow-lg">
                            <p className="text-xs font-black text-slate-900 dark:text-white uppercase tracking-widest">Cancelado</p>
                          </div>
                        )}
                      </div>
                    )}
