      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          >
            ...
            >
              <svg className="w-4 h-4 text-slate-500 dark:text-slate-400 group-hover:text-slate-900 dark:hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
