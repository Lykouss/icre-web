...
export function MaintenanceCountdown({ expectedEndAt, serverTime, autoDeactivate }: { expectedEndAt: string | null, serverTime?: number, autoDeactivate: boolean }) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 px-4 py-2 rounded-full text-slate-600 dark:text-slate-300">
