  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 pt-28 pb-20 px-4">
      ...
      <div className="relative max-w-4xl mx-auto">
        ...
        {/* ── Estado vazio ── */}
        {!hasAny && (
          <div className="bg-slate-50 dark:bg-slate-900/50 border border-white/6 rounded-2xl p-16 text-center">
            <div className="w-16 h-16 bg-slate-800/80 border border-black/5 dark:border-white/8 rounded-2xl flex items-center justify-center mx-auto mb-5">
              <svg className="w-8 h-8 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
              </svg>
            </div>
            <h2 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Nenhuma inscrição encontrada</h2>
    ...
    <div className={`border rounded-xl transition-all duration-200 ${cardStyles[variant]}`}>
      <div className="p-5 flex flex-col md:flex-row gap-4 items-start md:items-center">
        ...
        <div className="flex-1 min-w-0">
          <h3 className={`text-sm font-bold mb-1.5 truncate ${isCancelled ? 'text-slate-500 line-through' : 'text-slate-900 dark:text-white'}`}>
            {event.title}
          </h3>
