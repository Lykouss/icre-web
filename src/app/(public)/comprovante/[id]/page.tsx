...
export default async function ComprovantePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!isOwner && !isAdmin) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-white via-blue-50/40 to-indigo-50/40 dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-blue-100 dark:bg-slate-900/60 backdrop-blur-xl border border-blue-300/60 dark:border-white/8 rounded-3xl p-8 text-center">
